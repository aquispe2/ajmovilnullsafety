...
class CasoModel {
  ...
  factory CasoModel.fromJson(Map<String, dynamic> json) => CasoModel(
        ...
        usuarioActualId: json["usuarioActualId"] ?? 0,
        oficinaId: json["oficinaId"] ?? 0,
        tipoRegistroId: json["tipoRegistroId"] ?? 0,
        descripcionRegistro: json["descripcionRegistro"] ?? '',
        tipoProcesoId: json["tipoProcesoId"] ?? 0,
