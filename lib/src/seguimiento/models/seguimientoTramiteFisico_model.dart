...
//
//     final seguimientoTramiteFisicoModel = seguimientoTramiteFisicoModelFromJson(jsonString);

import 'dart:convert';

SeguimientoTramiteFisicoModel seguimientoTramiteFisicoModelFromJson(
        String str) =>
    SeguimientoTramiteFisicoModel.fromJson(json.decode(str));

String seguimientoTramiteFisicoModelToJson(
        SeguimientoTramiteFisicoModel data) =>
    json.encode(data.toJson());

class SeguimientoTramiteFisicoModel {
  SeguimientoTramiteFisicoModel({
    this.recepcionId = 0,
    this.usuarioId = 0,
    this.oficinaId = 0,
  ...
  factory SeguimientoTramiteFisicoModel.fromJson(Map<String, dynamic> json) =>
      SeguimientoTramiteFisicoModel(
